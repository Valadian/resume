...
function ResumeModel(){
    ...
    this.employment = ko.observableArray([
        ...
        BuildEntry({
            ...
            title:'Boeing',
            location:'Houston, TX',
            text:['• Summer 2007 [Boeing Commercial Airplanes] Loadable Software Intern',
                  '• Summer 2008 [Boeing Integrated Defense Systems] Support Systems Intern',
                  '• 2009 [Boeing Defense, Space & Security] Support Systems/Lab Engineering'],
            classes:'entry-company'}),
        // BuildEntry({
        //     image:'https://www.boeing.com/assets/images/logo.png',
        //     start:'Summer 2009',
